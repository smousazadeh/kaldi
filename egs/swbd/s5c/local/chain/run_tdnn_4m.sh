...
# not 0.0001.  No clear difference with 4l.

#./compare_wer.sh 4f 4l 4m
#System                       4f        4l        4m
#WER on train_dev(tg)      16.83     16.74     16.75
#WER on train_dev(fg)      15.73     15.47     15.35
#WER on eval2000(tg)        18.4      18.4      18.4
#WER on eval2000(fg)        16.6      16.7      16.8
#Final train prob      -0.105832 -0.108047  -0.10169
#Final valid prob      -0.123021 -0.125309 -0.120332
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_4m # Note: _sp will get added to this if $speed_perturb == true.
