...
# i.e. making the first splice-indexes wider again.  WER is worse by about 0.2,0.0,0.5,0.3.
# The final train-prob is better -0.1058->-0.1043, and valid-prob is worse -0.1230->0.1236.
#./show_wer.sh 4i
#%WER 16.97 [ 8349 / 49204, 1028 ins, 2114 del, 5207 sub ] exp/chain/tdnn_4i_sp/decode_train_dev_sw1_tg/wer_9_0.0
#%WER 15.74 [ 7747 / 49204, 875 ins, 2267 del, 4605 sub ] exp/chain/tdnn_4i_sp/decode_train_dev_sw1_fsh_fg/wer_10_0.0
#%WER 18.9 | 4459 42989 | 82.9 10.9 6.2 1.9 18.9 56.9 | exp/chain/tdnn_4i_sp/decode_eval2000_sw1_tg/score_10_0.0/eval2000_hires.ctm.filt.sys
#%WER 16.9 | 4459 42989 | 85.0 10.0 5.0 1.9 16.9 53.5 | exp/chain/tdnn_4i_sp/decode_eval2000_sw1_fsh_fg/score_9_0.0/eval2000_hires.ctm.filt.sys
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_4i # Note: _sp will get added to this if $speed_perturb == true.
