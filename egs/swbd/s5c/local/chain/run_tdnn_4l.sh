...
# _4l is as _4f, but using the 2-level tree for modified application of l2
# regularization; and increasing the constant again from 0.00005 to 0.0001 (as
# in 4e) as I think a higher value will work better in this setup.  Using
# --leaves-per-group 10.
# Generally better than 4f, but not 100% consistent (0.1% degradation on
# eval2000,fg).

#./compare_wer.sh 4e 4f 4l
#System                       4e        4f        4l
#WER on train_dev(tg)      17.09     16.83     16.74
#WER on train_dev(fg)      15.91     15.73     15.47
#WER on eval2000(tg)        18.5      18.4      18.4
#WER on eval2000(fg)        16.9      16.6      16.7
#Final train prob      -0.114859 -0.105832 -0.108047
#Final valid prob      -0.126672 -0.123021 -0.125309
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_4l # Note: _sp will get added to this if $speed_perturb == true.
