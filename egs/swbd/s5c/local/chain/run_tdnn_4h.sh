...
# _4h is as _4f, but further halving the regularization from 0.00005 to 0.000025.
# WER change vs 4f is not consistent and the average change is slightly for the worse (0.0, -0.2, +0.1, +0.2).
#./show_wer.sh 4h
#%WER 16.83 [ 8281 / 49204, 927 ins, 2211 del, 5143 sub ] exp/chain/tdnn_4h_sp/decode_train_dev_sw1_tg/wer_10_0.0
#%WER 15.57 [ 7663 / 49204, 895 ins, 2098 del, 4670 sub ] exp/chain/tdnn_4h_sp/decode_train_dev_sw1_fsh_fg/wer_10_0.0
#%WER 18.5 | 4459 42989 | 83.5 10.9 5.6 2.0 18.5 56.5 | exp/chain/tdnn_4h_sp/decode_eval2000_sw1_tg/score_10_0.0/eval2000_hires.ctm.filt.sys
#%WER 16.8 | 4459 42989 | 85.0 9.7 5.3 1.9 16.8 53.3 | exp/chain/tdnn_4h_sp/decode_eval2000_sw1_fsh_fg/score_10_0.0/eval2000_hires.ctm.filt.sys

# It's even better than 4e, by about 0.3% abs.
#                        4c    4e      4f        4h
#  Final valid prob:   -0.1241 -0.1267  -0.1230 -0.1242
#  Final train prob:   -0.08820 -0.1149 -0.1058  -0.9947
# Final valid-set l2:    0      -0.020   -0.016  -0.014
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_4h # Note: _sp will get added to this if $speed_perturb == true.
