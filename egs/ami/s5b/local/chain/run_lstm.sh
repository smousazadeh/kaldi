...
# This is a chain-training script with LSTM neural networks.

# what I ran first:
# local/chain/run_lstm.sh --use-ihm-ali true --mic sdm1 --train-set train --gmm tri3 --nnet3-affix "" --stage 15 &
# next: changed in components.py:
#    ng_per_element_scale_options += " param-mean=0.0 param-stddev=0.0 "
# and ran:
# local/chain/run_lstm.sh --common-egs-dir exp/sdm1/chain/lstma_sp_bi_ihmali/egs --use-ihm-ali true --mic sdm1 --train-set train --gmm tri3 --nnet3-affix "" --lstm-affix "b" --stage 15 &
# next changed it to:
#   ng_per_element_scale_options += " param-mean=0.0 param-stddev=0.0 learning-rate-factor=5.0 "
# and ran:
# local/chain/run_lstm.sh --common-egs-dir exp/sdm1/chain/lstma_sp_bi_ihmali/egs --use-ihm-ali true --mic sdm1 --train-set train --gmm tri3 --nnet3-affix "" --lstm-affix "c" --stage 15 &

# Please see RESULTS_* for examples of command lines invoking this script.


# local/nnet3/run_lstm.sh --stage 8 --use-ihm-ali true --mic sdm1 # rerunning with biphone
# local/nnet3/run_lstm.sh --stage 8 --use-ihm-ali false --mic sdm1

# local/chain/run_lstm.sh --use-ihm-ali true --mic sdm1 --train-set train --gmm tri3 --nnet3-affix "" --stage 12 &

# local/chain/run_lstm.sh --use-ihm-ali true --mic mdm8 --stage 12 &
# local/chain/run_lstm.sh --use-ihm-ali true --mic mdm8 --train-set train --gmm tri3 --nnet3-affix "" --stage 12 &

# local/chain/run_lstm.sh --mic sdm1 --use-ihm-ali true --train-set train_cleaned  --gmm tri3_cleaned&
...
lstm_affix=a  #affix for LSTM directory, e.g. "a" or "b", in case we change the configuration.
...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/lstm${lstm_affix}_sp_bi_ihmali
  ...
  dir=exp/$mic/chain${nnet3_affix}/lstm${lstm_affix}_sp_bi
fi
