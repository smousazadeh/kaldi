...
class XconfigOutputLayer(XconfigLayerBase):
    ...
    Parameters of the class, and their defaults:
        ...
        ng-linear-options=''  :   Options, like ng-affine-options, that are passed to
             ...
             is supplied).
        alpha='', power='':   Options for the natural gradient, will be set in both
                              the affine layer and, if there is a bottleneck, the
                              linear layer.
    """
    ...
    def set_default_configs(self):
        ...
        self.config = {'input': '[-1]',
                       ...
                       'alpha': '',                 # effective default: 4.0
                       'power': '',                 # effective default: 1.0
    ...
    def _generate_config(self):
        ...
        for opt in [ 'learning-rate-factor', 'alpha', 'power',
                     'l2-regularize', 'max-change', 'param-stddev',
                     'bias-stddev' ]:
            if self.config[opt] != '':
...
class XconfigBasicLayer(XconfigLayerBase):
    ...
    def _add_components(self, input_desc, input_dim, nonlinearities):
        ...
        for opt_name in [ 'max-change', 'learning-rate-factor',
                          'bias-stddev', 'l2-regularize', 'alpha', 'power' ]:
