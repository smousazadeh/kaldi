...
# It does seem to help a bit!  (but see below).
...
# .. but comparing it with the original 10h experiment does not show a very compelling
#  improvement.
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10h_sp_bi exp/chain_cleaned/tdnn1f12e_sp_bi
# System                tdnn1f10h_sp_bi tdnn1f12e_sp_bi
# WER on dev(orig)            8.1       7.9
# WER on dev(rescored)        7.5       7.4
# WER on test(orig)           8.1       8.1
# WER on test(rescored)       7.7       7.7
# Final train prob        -0.0603   -0.0615
# Final valid prob        -0.0893   -0.0908
# Final train prob (xent)   -0.8857   -0.8853
# Final valid prob (xent)   -1.0092   -0.9849
# Num-params                 9953312   9776912
