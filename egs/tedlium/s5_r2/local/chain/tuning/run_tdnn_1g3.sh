...
tdnn_affix=1g3  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  nudge_opts='nudge-options="scale=1.0e-04 p1=-1.0 p2=-0.05 p3=0.0 p4=0.025 p5=0.5" self-repair-scale=1.0e-04'
