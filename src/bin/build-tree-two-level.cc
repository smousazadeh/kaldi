...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    const char *usage =
        ...
        "<mapping-out> is written using standard Kaldi mechanisms as an vector of int32;\n"
        "it is a mapping from the pdf-id of the detailed tree to the pdf-id of the coarse\n"
        "tree (both zero-based)\n"
        "\n"
